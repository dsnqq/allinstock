...
DynamicAdapt.prototype.init = function () {
    ...
    for (var i = 0; i < this.nodes.length; i++) {
        ...
        оbject.parentChildren = оbject.parent.children.length;
    ...
    if (matchMedia.matches) {
        ...
        for (var _i2 = 0; _i2 < оbjects.length; _i2++) {
            ...
            if (_оbject.element.classList.contains(this.daClassname)) {
                this.moveBack(_оbject.parent, _оbject.element, _оbject.index, _оbject.parentChildren);
            }
        }
    }
};
...
// Функция возврата
DynamicAdapt.prototype.moveBack = function (parent, element, index, parentChildren) {
    element.classList.remove(this.daClassname);
    console.log(parent.children);
    if (parent.children.length > parentChildren) {
        index++;
    }
